...
export const services = [
  {
    ...
    tagline: "We don’t just build websites—we build digital powerhouses.",
    description:
      "Your website is your first impression. We make it unforgettable. Our web development team crafts fast, responsive, SEO-friendly, and fully custom websites that don’t just look good—they work hard to grow your business.",
    features: [
      "From static landing pages to full-stack dynamic platforms, eCommerce stores, admin dashboards, or booking systems—we develop it all with clean code, modern UI/UX, and future-proof tech.",
      "We use the latest technologies (HTML5, CSS3, JavaScript, React, WordPress, Laravel, etc.) to ensure your site is secure, scalable, and stunning.",
    ],
    servicesOffered: [
      "Custom Website Development",
      "Business & Portfolio Sites",
      "E-commerce Development (WooCommerce, Shopify)",
      "Admin Dashboard & CRM Panels",
      "WordPress/React/Laravel/Node-based Solutions",
      "Blog/News/Magazine Sites",
      "API Integrations",
    ...
    whyChooseUs: [
      ...
      "Fully secured with SSL & best practices",
      "Total support, even after delivery",
    ],
    icon: "🛠️",
  ...
  },
  {
    ...
    description:
      "We don’t just create visuals—we craft experiences. Our graphic design team blends creativity with strategy to deliver designs that grab attention, build trust, and make your brand unforgettable.",
    features: [
      "From eye-catching social media posts to professional branding kits, product packaging, and ad creatives—we design with purpose, not just pixels.",
      "Whether you're a startup needing a fresh identity or a brand looking to level up—we’ve got the tools, taste, and talent.",
    ],
    servicesOffered: [
      ...
      "Presentation Slides (Pitch Decks, Company Profiles)",
      "Poster, Banner & Billboard Design",
      "UI/UX Graphics & Web Assets",
      "T-shirt & Merch Design",
      "Motion Graphics & Custom Illustrations",
    ],
    whyChooseUs: [
      "Unique, trend-driven design",
      "Unlimited creativity with clear messaging",
